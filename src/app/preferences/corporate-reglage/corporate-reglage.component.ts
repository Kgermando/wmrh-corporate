...
import { CorporateReglageModel } from './models/reglage-model';
...
@Component({
  selector: 'app-corporate-reglage',
  templateUrl: './corporate-reglage.component.html',
  styleUrls: ['./corporate-reglage.component.scss']
})
export class CorporateReglageComponent implements OnInit {
  isLoading = false;

  preference: CorporateReglageModel;
  ...
  constructor(
    ...
    private reglageService: CorporateReglageService,
    ...
    openEditDialog(enterAnimationDuration: string, exitAnimationDuration: string, reglage: string, valeur: any): void {
      this.dialog.open(EditCorporateReglageDialogBox, {
        width: '600px',
        enterAnimationDuration,
        exitAnimationDuration,
        data: {
...
@Component({
  selector: 'edit-corporate-reglage-dialog',
  templateUrl: './corporate-reglage-edit.html',
})
export class EditCorporateReglageDialogBox implements OnInit{
  isLoading = false;
  ...
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
      public dialogRef: MatDialogRef<EditCorporateReglageDialogBox>,
