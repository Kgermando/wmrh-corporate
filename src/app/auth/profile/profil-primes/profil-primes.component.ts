...
@Component({
  selector: 'app-profil-primes',
  templateUrl: './profil-primes.component.html',
  styleUrls: ['./profil-primes.component.scss']
})
export class ProfilPrimesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.authService.user().subscribe({
        next: (user) => {
            ...
            this.ELEMENT_DATA = this.currentUser.primes;
