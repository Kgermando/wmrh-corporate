...
@Component({
  selector: 'app-presence-pie-year',
  templateUrl: './presence-pie-year.component.html',
  styleUrls: ['./presence-pie-year.component.scss']
})
export class PresencePieYearComponent implements OnInit{
  ...
  constructor( private presenceService: PresenceService) { }
    ...
    getPie() {
        this.presenceService.getPieYEAR(this.personne.code_entreprise, this.personne.matricule).subscribe(
            res => {
