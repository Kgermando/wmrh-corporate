...
@Component({
  selector: 'app-presence-pie-all',
  templateUrl: './presence-pie-all.component.html',
  styleUrls: ['./presence-pie-all.component.scss']
})
export class PresencePieAllComponent implements OnInit {
  ...
  constructor( private presenceService: PresenceService) { }
    ...
    getPie() {
        this.presenceService.getPieAll(this.personne.code_entreprise, this.personne.matricule).subscribe(
            res => {
